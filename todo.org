...
** TODO Migrate current backlog.org and latest pomodoro files to todo.org :homework:
...
** TODO Buy domains:						    :startup:
*** euromillones.juegos
*** euromillones.tienda
*** euromillones.online
*** loteria.chrismas
*** loteria-navidad.club
*** loteria-navidad.tienda
...
- Deploy jobs
*** Launch getboo
** TODO Make room in S3's SD card
