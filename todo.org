...
* Today
#+CATEGORY: today
** TODO Fix apache for companies (tokenization-ok.jsp)
   [2014-11-13 Thu]
** STARTED Review app-es-0{1,2,3,4}-c processes
...
#+CATEGORY: Tasks
   [2014-10-30 Thu]
** TODO Review the exact phrase to use for acknowledging shutterstock images
   [2014-11-11 Tue]
** TODO Recover access to admin.ventura24.es/backoffice
   [2014-11-05 Wed]
