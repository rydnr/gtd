...
** STARTED Fix logo bug in services T324		       :services:v24:
   ...
   [2014-09-23 Tue]
*** TODO Debug OpenCMS locally against remote db
   [2014-10-09 Thu]
...
** STARTED Redactar acta de la reunión del sindicato		  :sindicato:
   ...
   [2014-10-06 Mon]
** TODO Call UGT to find out if the acta has to be signed by the company :sindicato:
   [2014-10-09 Thu]
* Tasks
#+CATEGORY: Tasks
** TODO 
...
** DONE Configure jenkins.acm-sl.org
   CLOSED: [2014-10-06 Mon 13:14]
...
** DONE Upload portel logo manually
